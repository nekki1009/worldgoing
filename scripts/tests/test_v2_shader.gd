...
void fragment() {
	if (mask_enabled) {
		...
		// Full forehead width (|X| <= 0.068), in front of skull (Z > 0.015), up to brow rim
		bool is_front_bangs = (head_local.z > 0.015 && head_local.y <= (brow_cut_y + 0.008) && abs(head_local.x) <= 0.068);
...
func _run() -> void:
	...
	# Female Hair 01 Front & 3/4 & Side & Back
	...
	var sh := Shader.new()
	sh.code = TEST_SHADER_V2
	_apply_sh(editor, true, sh, 0.105)

	editor.set_preview_yaw_degrees(0.0)
	await _settle(6)
	_save_capture("v2_female_leather_h1_front.png")

	editor.set_preview_yaw_degrees(35.0)
	await _settle(6)
	_save_capture("v2_female_leather_h1_34.png")

	editor.set_preview_yaw_degrees(85.0)
	await _settle(6)
	_save_capture("v2_female_leather_h1_side.png")

	editor.set_preview_yaw_degrees(175.0)
	await _settle(6)
	_save_capture("v2_female_leather_h1_back.png")

	# Female Hair 02 Back & Side
	editor.select_part_by_id(&"hair", &"hair_short_02")
	_apply_sh(editor, true, sh, 0.105)
	editor.set_preview_yaw_degrees(175.0)
	await _settle(6)
	_save_capture("v2_female_leather_h2_back.png")
	editor.set_preview_yaw_degrees(35.0)
	await _settle(6)
	_save_capture("v2_female_leather_h2_34.png")

	# Female Hair 04 Back & 3/4
	editor.select_part_by_id(&"hair", &"hair_short_04")
	_apply_sh(editor, true, sh, 0.105)
	editor.set_preview_yaw_degrees(175.0)
	await _settle(6)
	_save_capture("v2_female_leather_h4_back.png")
	editor.set_preview_yaw_degrees(35.0)
	await _settle(6)
	_save_capture("v2_female_leather_h4_34.png")

	# Male Hair 01 Front & Side & Back
	...
	_apply_sh(editor, false, sh, 0.105)

	editor.set_preview_yaw_degrees(0.0)
	await _settle(6)
	_save_capture("v2_male_leather_h1_front.png")
	editor.set_preview_yaw_degrees(85.0)
	await _settle(6)
	_save_capture("v2_male_leather_h1_side.png")
	...
	editor.set_preview_yaw_degrees(175.0)
	await _settle(6)
	_save_capture("v2_male_leather_h3_back.png")

	print("V2_TEST_RUN_DONE")
	editor.queue_free()
	await _settle(4)
	quit(0)
